  ...
  return (
    <div className={styles.homeContainer}>
      ...
      <div className={styles.introText}>
        Welcome! Explore how courses, programs, and departments are connected at
      ...
      <div className={styles.sectionBlock}>
        <h2>
          Graph Explorer: <Link to="/2dgraph">2D Graph</Link> |{" "}
          <Link to="/3dforcegraph">3D Graph</Link>
        </h2>
        <div>
      ...
      <div className={styles.sectionBlock}>
        <h2>
          <Link to="/globalstats">Global Statistics</Link>
        </h2>
        <div>
          Get an overview of the global statistics across courses at the Faculty
          of Arts & Science.
        </div>
      </div>
      ...
      <div className={styles.sectionBlock}>
        <h2>
          <Link to="/pathexplorer">Path Explorer</Link>
        </h2>
        <div>
